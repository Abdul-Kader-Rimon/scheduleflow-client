    ...
    <div className="min-h-screen flex bg-gray-50 overflow-hidden relative">
      ...
      >
        <div className="p-6 flex items-center justify-between border-b border-gray-50 min-w-[280px]">
          <Link
            to="/"
            className="text-2xl font-bold text-[#2FA084] whitespace-nowrap"
          >
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto min-w-[280px]">
          ...
          {role === "teacher" && (
            <>
              <NavLink to="/dashboard/teacher" end className={navItemStyles}>
                Overview
              </NavLink>
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50 space-y-3 min-w-[280px]">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-red-500 hover:bg-red-50 rounded-lg transition-colors group"
          >
      ...
      <motion.div
        animate={{
          marginLeft: window.innerWidth > 768 && isOpen ? "280px" : "0px",
        }}
        transition={{ type: "spring", stiffness: 300, damping: 30 }}
